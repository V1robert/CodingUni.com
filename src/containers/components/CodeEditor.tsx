...
const CodeEditor = () => {
  ...
  public static void main(String[] args) {
    ...
    const [trigger, {data, isFetching}] = useLazyGetJavaOutputQuery()
    ...
    return (
        <div className="row g-0 w-100 mx-auto"
            ...
            {/* Editor Section */}
            <div
                className={`${data ? 'col-lg-8 border-bottom border-lg-bottom-0 border-lg-end' : 'col-12'} d-flex flex-column`}
                ...
                >
                    <div
                        ...
                        <div className="d-flex align-items-center gap-2">
                            <div className={`rounded-circle ${data.httpCode === 200 ? 'bg-success' : 'bg-danger'}`}
